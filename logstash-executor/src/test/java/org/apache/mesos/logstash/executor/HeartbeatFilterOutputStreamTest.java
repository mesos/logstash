...
public class HeartbeatFilterOutputStreamTest {
    ...
    final String TEST_STRING = String
        .format("Hello\n%c Ignore me\nWorld!", HeartbeatFilterOutputStream.MAGIC_CHARACTER);
    ...
    public void magicCharacterIsOneByteUTF8() throws Exception {
        final String singleByteString = HeartbeatFilterOutputStream.MAGIC_CHARACTER + "";
    ...
    public void ignoresMagicCharacterWhenInvokingMultipleTimes() throws Exception {
        ...
        target.write('a');
        target.write(HeartbeatFilterOutputStream.MAGIC_CHARACTER);
        target.write('a');
        target.write('a');
        target.write('\n');
        target.write('b');
